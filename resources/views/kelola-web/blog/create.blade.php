<x-header-dashboard>
    <x-slot:title>Tambah Blog</x-slot:title>
    <x-slot:description>Buat artikel blog baru</x-slot:description>
</x-header-dashboard>
...
<div class="max-w-4xl bg-white rounded-xl shadow p-6 mt-6">
    ...
    <form action="{{ route('admin.web.blog.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="flex flex-col md:flex-row gap-6 items-start">
            ...
            {{-- Thumbnail Preview --}}
            <div class="md:w-1/3">
                <p class="text-sm font-medium mb-2">Thumbnail</p>
        ...
        <div>
            ...
            <textarea name="content" rows="7"
                class="w-full border rounded-lg px-3 py-2
                             focus:ring focus:ring-orange-300" required>{{ old('content') }}</textarea>
        </div>
