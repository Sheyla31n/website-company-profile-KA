<x-header-dashboard>
    ...
    <x-slot:description>Ubah nama dan logo partner</x-slot:description>
</x-header-dashboard>
...
<div class="max-w-4xl bg-white rounded-xl shadow p-6 mt-6">
    ...
    <form action="{{ route('admin.web.partner.update', $partner->id) }}" method="POST" enctype="multipart/form-data"
        class="space-y-6">
        ...
        <div class="flex flex-col md:flex-row gap-6 items-start">
            ...
            <div class="md:w-1/3 justify-items-center">
                <p class="text-sm font-medium mb-2">Logo Saat Ini</p>
